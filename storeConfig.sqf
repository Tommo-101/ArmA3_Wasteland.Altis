...
allVehStoreVehicles = compileFinal str (call landArray + call lightInfArray + call armoredArray + call antiArray + call tanksArray + call helicoptersArray + call planesArray + call boatsArray + call utilityArray);
