...
[
	...
	// Assault Rifles
	["Mk20 Carbine", "arifle_Mk20C_plain_F", 2000],
	["Mk20 Carbine (Camo)", "arifle_Mk20C_F", 2000],
	...
	["AKU-12 Carbine", "arifle_AK12U_F", 2000],
	["AKU-12 Carbine (Arid)", "arifle_AK12U_arid_F", 2000],
	["AKU-12 Carbine (Lush)", "arifle_AK12U_lush_F", 2000],
	["AK-12 Rifle", "arifle_AK12_F", 250],
	["AK-12 Rifle (Arid)", "arifle_AK12_arid_F", 2500],
	["AK-12 Rifle (Lush)", "arifle_AK12_lush_F", 2500],
	["AK-12 GL Rifle", "arifle_AK12_GL_F", 300],
	["AK-12 GL Rifle (Arid)", "arifle_AK12_GL_arid_F", 3000],
	["AK-12 GL Rifle (Lush)", "arifle_AK12_GL_lush_F", 3000],

	["Promet Rifle", "arifle_MSBS65_F", 2000],
	["Promet Rifle (Black)", "arifle_MSBS65_black_F", 2000],
	["Promet Rifle (Camo)", "arifle_MSBS65_camo_F", 2000],
	["Promet Rifle (Sand)", "arifle_MSBS65_sand_F", 2000],
	["Promet GL Rifle", "arifle_MSBS65_GL_F", 2500],
	["Promet GL Rifle (Black)", "arifle_MSBS65_GL_black_F", 2500],
	["Promet GL Rifle (Camo)", "arifle_MSBS65_GL_camo_F", 2500],
	["Promet GL Rifle (Sand)", "arifle_MSBS65_GL_sand_F", 2500],
	["Promet SG Rifle", "arifle_MSBS65_UBS_F", 2500],
	["Promet SG Rifle (Black)", "arifle_MSBS65_UBS_black_F", 2500],
	["Promet SG Rifle (Camo)", "arifle_MSBS65_UBS_camo_F", 2500],
	["Promet SG Rifle (Sand)", "arifle_MSBS65_UBS_sand_F", 2500],

	// Marksman Rifles
	["Promet MR Rifle", "arifle_MSBS65_Mark_F", 3000],
	["Promet MR Rifle (Black)", "arifle_MSBS65_Mark_black_F", 3000],
	["Promet MR Rifle (Camo)", "arifle_MSBS65_Mark_camo_F", 3000],
	["Promet MR Rifle (Sand)", "arifle_MSBS65_Mark_sand_F", 3000],
	...
	["Mk14 Rifle (Classic)", "srifle_DMR_06_hunter_F", 5000],
...
[
	...
	["RPK-12 LMG", "arifle_RPK12_F", 5000],
	["RPK-12 LMG (Arid)", "arifle_RPK12_arid_F", 5000],
	["RPK-12 LMG (Lush)", "arifle_RPK12_lush_F", 5000],
...
[
	...
	["MAAWS Mk4 Mod 0 (Green)", "launch_MRAWS_green_rail_F", 6000, "noDLC"], // RPG-42 and MAAWS are similar, but MAAWS has longer range
	["MAAWS Mk4 Mod 0 (Olive)", "launch_MRAWS_olive_rail_F", 6000, "noDLC"],
	["MAAWS Mk4 Mod 0 (Sand)", "launch_MRAWS_sand_rail_F", 6000, "noDLC"],
	["MAAWS Mk4 Mod 1 (Green)", "launch_MRAWS_green_F", 7500, "noDLC"], // MAAWS Mod 1 has nightvision and laser rangefinder, while Mod 0 doesn't
	["MAAWS Mk4 Mod 1 (Olive)", "launch_MRAWS_olive_F", 7500, "noDLC"],
	["MAAWS Mk4 Mod 1 (Sand)", "launch_MRAWS_sand_F", 7500, "noDLC"],
	["9M135 Vorona (Brown)", "launch_O_Vorona_brown_F", 20000, "noDLC"],
	["9M135 Vorona (Green)", "launch_O_Vorona_green_F", 20000, "noDLC"],
	...
	["Titan MPRL AA (Sand)", "launch_Titan_F", 15000],
	["Titan MPRL AA (Hex)", "launch_O_Titan_F", 15000],
	["Titan MPRL AA (Digi)", "launch_I_Titan_F", 15000],
	["Titan MPRL AA (Tropic)", "launch_B_Titan_tna_F", 15000, "noDLC"],
	["Titan MPRL AA (G Hex)", "launch_O_Titan_ghex_F", 15000, "noDLC"]
];
...
[
	...
	["APERS Bounding Mine", "APERSBoundingMine_Range_Mag", 2000],
	["APERS Mine", "APERSMine_Range_Mag", 2000],
	["Claymore Charge", "ClaymoreDirectionalMine_Remote_Mag", 2000],
	["M6 SLAM Mine", "SLAMDirectionalMine_Wire_Mag", 3500],
	["AT Mine", "ATMine_Range_Mag", 4000],
	["Explosive Charge", "DemoCharge_Remote_Mag", 8500],
...
[
	...
	["RPG-42 AT Rocket", "RPG32_F", 4000],                     //                 422     |                 28,  2.5m     |           none
	["RPG-42 HE Rocket", "RPG32_HE_F", 3000],                  //                 200     |                 50,  6.0m     |           none
	["MAAWS HEAT 75 Rocket", "MRAWS_HEAT_F", 5000],            //                 495     |                 14,  2.0m     |           none
	["MAAWS HEAT 55 Rocket", "MRAWS_HEAT55_F", 4500],          //                 450     |                 14,  2.0m     |           none
	["MAAWS HE 44 Rocket", "MRAWS_HE_F", 4000],                //                 200     |                 50,  6.0m     |           none
	["9M135 HEAT Missile", "Vorona_HEAT", 10000],              //                 634     |                 28,  2.5m     |           mouse
	["9M135 HE Missile", "Vorona_HE", 7500],                   //                 220     |                 45,  8.0m     |           mouse
	["PCML AT Missile", "NLAW_F", 7500],                       //                 462     |                 25,  2.4m     |           laser/IR, cold/hot ground vehicles
	["Titan Anti-Tank Missile", "Titan_AT", 10000],            //                 515     |                 20,  2.0m     |           mouse, laser/IR, hot ground vehicles
	["Titan Anti-Personnel Missile", "Titan_AP", 7500],        //                 100     |                 25, 10.0m     |           mouse, laser/IR
...
[
	...
	["NV Goggles (Tropic)", "NVGoggles_tna_F", 1000, "nvg", "noDLC"],
	["Compact NVG (Hex)", "O_NVGoggles_hex_F", 1500, "nvg", "noDLC"],
	["Compact NVG (G Hex)", "O_NVGoggles_ghex_F", 1500, "nvg", "noDLC"],
	["Compact NVG (Green)", "O_NVGoggles_grn_F", 1500, "nvg", "noDLC"],
	["Compact NVG (Urban)", "O_NVGoggles_urb_F", 1500, "nvg", "noDLC"],
